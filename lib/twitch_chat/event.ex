defmodule TwitchChat.Event do
  ...
  # ## Options
  #
  #   * `:fields` - A list of field names. Must match the types in `TwitchChat.Fields`.
  #      Required.
  #
  # ## Example
  #
  #     defmodule TwitchChat.Events.Foo
  #       use TwitchChat.Event, fields: [:foo, :bar]
  #     end
  #
  ...
  defmacro __using__(opts) do
    ...
    field_types =
      for field_name <- fields do
        {field_name, quote(do: TwitchChat.Fields.unquote(field_name))}
      end
