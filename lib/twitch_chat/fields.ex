defmodule TwitchChat.Fields do
  @moduledoc """
  Fields derived from Twitch IRC tags.
  """

  @typedoc """
  Found in TwitchChat EventSub subscriptions `channel.shoutout.receive`.
  """
  ...
  @typedoc """
  Found in TwitchChat EventSub subscriptions `channel.follow`.
  """
